...
const History = ({ liked, disliked }) => {
  return (
    <div className="history-page">
      <h1 className="history-title">Your last actions:</h1>
      <div className="last-action">
        <div className="last-card-container">
          ...
          {!liked ? (
            ...
            <div
              className="last-card last-liked"
              style={{ backgroundImage: `url(${liked.picture})` }}
            >
              <p className="card-title">{liked.name}</p>
            </div>
          )}
        </div>
        <div className="last-card-container">
          ...
          {!disliked ? (
            ...
            <div
              className="last-card last-disliked"
              style={{ backgroundImage: `url(${disliked.picture})` }}
            >
              <p className="card-title">{disliked.name}</p>
            </div>
          )}
        </div>
      </div>
